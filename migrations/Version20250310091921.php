 ...
 */
final class Version20250310091921 extends AbstractMigration
{
...
//        $this->addSql('ALTER TABLE enova_contractor ADD PRIMARY KEY (id)');
        $this->addSql('ALTER TABLE enova_order_item DROP product_name, CHANGE towar_enova_id towar_enova_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE enova_order_item ADD CONSTRAINT FK_2967A02E430C0DB0 FOREIGN KEY (towar_enova_id) REFERENCES enova_product (id)');
        $this->addSql('CREATE INDEX IDX_2967A02E430C0DB0 ON enova_order_item (towar_enova_id)');
...
//        $this->addSql('CREATE UNIQUE INDEX UNIQ_AE9077EBE7927C74 ON user_enova (email)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE enova_order_item DROP FOREIGN KEY FK_2967A02E430C0DB0');
        $this->addSql('DROP INDEX IDX_2967A02E430C0DB0 ON enova_order_item');
        $this->addSql('ALTER TABLE enova_order_item ADD product_name VARCHAR(255) NOT NULL, CHANGE towar_enova_id towar_enova_id INT NOT NULL');
