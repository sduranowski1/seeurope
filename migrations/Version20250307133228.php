...
final class Version20250307133228 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE enova_product_item (id INT AUTO_INCREMENT NOT NULL, enova_product_id INT NOT NULL, towar_enova_id INT NOT NULL, product_name VARCHAR(255) NOT NULL, price NUMERIC(10, 2) NOT NULL, quantity INT NOT NULL, currency VARCHAR(10) NOT NULL, INDEX IDX_13E8604A3E09D97D (enova_product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
