...
final class Version20250110152604 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE enova_location (kod VARCHAR(50) NOT NULL, contractor_id INT NOT NULL, nazwa VARCHAR(255) NOT NULL, e_mail VARCHAR(255) DEFAULT NULL, INDEX IDX_C9F392EFB0265DC7 (contractor_id), PRIMARY KEY(kod)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE enova_location ADD CONSTRAINT FK_C9F392EFB0265DC7 FOREIGN KEY (contractor_id) REFERENCES enova_contractor (id_enova)');
        $this->addSql('ALTER TABLE enova_contractor ADD kod VARCHAR(255) NOT NULL');
...
//        $this->addSql('CREATE INDEX IDX_466113F63CF0C7D9 ON product_info (itypeid)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE enova_location DROP FOREIGN KEY FK_C9F392EFB0265DC7');
        $this->addSql('DROP TABLE enova_location');
        $this->addSql('ALTER TABLE enova_contractor DROP kod');
