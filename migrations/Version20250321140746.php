 ...
 */
final class Version20250321140746 extends AbstractMigration
{
...
//        $this->addSql('CREATE INDEX IDX_466113F63CF0C7D9 ON product_info (itypeid)');
        $this->addSql('ALTER TABLE test_enova_contact_person ADD email VARCHAR(255) DEFAULT NULL, ADD tel_komorkowy VARCHAR(50) DEFAULT NULL, ADD dostep_do_www TINYINT(1) NOT NULL, ADD prawo_do_zamowien TINYINT(1) NOT NULL');
...
//        $this->addSql('CREATE UNIQUE INDEX UNIQ_AE9077EBE7927C74 ON user_enova (email)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE test_enova_contact_person DROP email, DROP tel_komorkowy, DROP dostep_do_www, DROP prawo_do_zamowien');
        $this->addSql('ALTER TABLE user_enova DROP FOREIGN KEY FK_AE9077EB1DEF328D');
