 ...
 */
final class Version20250325154220 extends AbstractMigration
{
...
//        $this->addSql('CREATE INDEX IDX_466113F63CF0C7D9 ON product_info (itypeid)');
        $this->addSql('ALTER TABLE test_enova_contact_person CHANGE id id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE test_enova_contact_person CHANGE id id INT AUTO_INCREMENT NOT NULL');
