 ...
 */
final class Version20250307142459 extends AbstractMigration
{
...
//        $this->addSql('ALTER TABLE enova_contractor ADD PRIMARY KEY (id)');
        $this->addSql('ALTER TABLE enova_order CHANGE pozycje_dok_handlowego old_pozycje_dok_handlowego JSON DEFAULT NULL COMMENT \'(DC2Type:json)\'');
...
//        $this->addSql('CREATE UNIQUE INDEX UNIQ_AE9077EBE7927C74 ON user_enova (email)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE enova_order CHANGE old_pozycje_dok_handlowego pozycje_dok_handlowego JSON DEFAULT NULL COMMENT \'(DC2Type:json)\'');
