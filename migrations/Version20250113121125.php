 ...
 */
final class Version20250113121125 extends AbstractMigration
{
...
//        $this->addSql('CREATE INDEX IDX_38F66DC864D218E ON enova_contractor (location_id)');
        $this->addSql('ALTER TABLE enova_location CHANGE kod kod VARCHAR(50) DEFAULT NULL, CHANGE nazwa nazwa VARCHAR(255) DEFAULT NULL');
...
//        $this->addSql('CREATE INDEX IDX_466113F63CF0C7D9 ON product_info (itypeid)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE enova_location CHANGE kod kod VARCHAR(50) NOT NULL, CHANGE nazwa nazwa VARCHAR(255) NOT NULL');
