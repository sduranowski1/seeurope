 ...
 */
final class Version20250129153403 extends AbstractMigration
{
...
//        $this->addSql('CREATE INDEX IDX_466113F63CF0C7D9 ON product_info (itypeid)');
        $this->addSql('ALTER TABLE user_enova ADD enova_person_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_AE9077EB1DEF328D ON user_enova (enova_person_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_AE9077EB1DEF328D ON user_enova');
        $this->addSql('ALTER TABLE user_enova DROP enova_person_id');
    }
}
