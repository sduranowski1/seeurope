 ...
 */
final class Version20241219112158 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE enova_product ADD product_info_id INT DEFAULT NULL, CHANGE name name VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE enova_product DROP product_info_id, CHANGE name name VARCHAR(255) NOT NULL');
    }
}
