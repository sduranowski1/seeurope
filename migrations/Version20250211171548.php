 ...
 */
final class Version20250211171548 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE machine_filter (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, polish_name VARCHAR(50) NOT NULL, german_name VARCHAR(50) NOT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
...
//        $this->addSql('ALTER TABLE enova_contractor ADD PRIMARY KEY (id)');
        $this->addSql('ALTER TABLE product_info ADD machine_filter_id INT DEFAULT 0');
...
//        $this->addSql('CREATE INDEX IDX_466113F63CF0C7D9 ON product_info (itypeid)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE machine_filter');
        ...
        $this->addSql('ALTER TABLE product_info DROP machine_filter_id');
    }
}
