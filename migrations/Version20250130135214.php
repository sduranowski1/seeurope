 ...
 */
final class Version20250130135214 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE enova_person ADD stanowisko VARCHAR(255) NOT NULL, ADD email VARCHAR(255) NOT NULL, ADD tel_komórkowy VARCHAR(255) NOT NULL');
...
//        $this->addSql('CREATE INDEX IDX_466113F63CF0C7D9 ON product_info (itypeid)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE enova_person DROP stanowisko, DROP email, DROP tel_komórkowy');
