 ...
 */
final class Version20250228123952 extends AbstractMigration
{
...
//        $this->addSql('ALTER TABLE enova_contractor ADD PRIMARY KEY (id)');
        $this->addSql('ALTER TABLE enova_order ADD email VARCHAR(255) NOT NULL');
...
//        $this->addSql('ALTER TABLE enova_order DROP email');
