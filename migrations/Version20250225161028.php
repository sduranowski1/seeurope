 ...
 */
final class Version20250225161028 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE brand ADD capacity TINYINT(1) NOT NULL, ADD depth TINYINT(1) NOT NULL, ADD dimension TINYINT(1) NOT NULL, ADD equipment_side TINYINT(1) NOT NULL, ADD existing_fork TINYINT(1) NOT NULL, ADD height TINYINT(1) NOT NULL, ADD information TINYINT(1) NOT NULL, ADD length TINYINT(1) NOT NULL, ADD machine_side TINYINT(1) NOT NULL, ADD masa_do TINYINT(1) NOT NULL, ADD masa_od TINYINT(1) NOT NULL, ADD model TINYINT(1) NOT NULL, ADD more_information TINYINT(1) NOT NULL, ADD opis_wc TINYINT(1) NOT NULL, ADD product TINYINT(1) NOT NULL, ADD recommended_machine_weight TINYINT(1) NOT NULL, ADD type TINYINT(1) NOT NULL, ADD variant TINYINT(1) NOT NULL, ADD volume TINYINT(1) NOT NULL, ADD weight TINYINT(1) NOT NULL, ADD width TINYINT(1) NOT NULL');
