 ...
 */
final class Version20250211152428 extends AbstractMigration
{
...
//        $this->addSql('ALTER TABLE enova_contractor ADD PRIMARY KEY (id)');
        $this->addSql('ALTER TABLE product_info CHANGE couplingFilterId coupling_filter_id INT DEFAULT 0');
...
//        $this->addSql('CREATE INDEX IDX_466113F63CF0C7D9 ON product_info (itypeid)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product_info CHANGE coupling_filter_id couplingFilterId INT DEFAULT 0');
    }
}
