 ...
 */
final class Version20250131140243 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE enova_contractor ADD id INT NOT NULL');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_38F66DC8BF396750 ON enova_contractor (id)');
...
//        $this->addSql('CREATE INDEX IDX_466113F63CF0C7D9 ON product_info (itypeid)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_38F66DC8BF396750 ON enova_contractor');
        $this->addSql('ALTER TABLE enova_contractor DROP id');
