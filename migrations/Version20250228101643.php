 ...
 */
final class Version20250228101643 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE enova_order (id INT AUTO_INCREMENT NOT NULL, id_www INT NOT NULL, id_enova INT NOT NULL, id_platnosci_internetowej VARCHAR(255) NOT NULL, numer_www VARCHAR(255) NOT NULL, numer_enova VARCHAR(255) NOT NULL, wartosc NUMERIC(10, 2) NOT NULL, wartosc_waluta NUMERIC(10, 2) NOT NULL, platnik INT NOT NULL, odbiorca INT NOT NULL, lokalizacja_dostawy JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', data DATETIME NOT NULL, opis VARCHAR(255) DEFAULT NULL, pozycje_dok_handlowego JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', termin_platnosci DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
...
//        $this->addSql('CREATE INDEX IDX_466113F63CF0C7D9 ON product_info (itypeid)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE enova_order');
