...
const FixedEnovaContractorList = () => {
    ...
    return (
        <List resource="test_enova_contractors" filters={postFilters} pagination={<AdminPagination />}>
...
export default FixedEnovaContractorList;