 ...
 */
final class Version20250304113625 extends AbstractMigration
{
...
//        $this->addSql('ALTER TABLE enova_contractor ADD PRIMARY KEY (id)');
        $this->addSql('ALTER TABLE enova_order ADD contact_person VARCHAR(255) DEFAULT NULL, ADD phone VARCHAR(255) DEFAULT NULL, ADD order_number VARCHAR(255) DEFAULT NULL, ADD shipping VARCHAR(255) DEFAULT NULL');
...
//        $this->addSql('CREATE UNIQUE INDEX UNIQ_AE9077EBE7927C74 ON user_enova (email)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE enova_order DROP contact_person, DROP phone, DROP order_number, DROP shipping');
