...
#[ApiResource(
    operations: [
        new GetCollection(),
        new GetCollection(
            uriTemplate: '/coupling_filters/no_pagination',
    ...
    normalizationContext: ['groups' => ['couplingFilter:read']],
    denormalizationContext: ['groups' => ['couplingFilter:create']]
)]
...
class CouplingFilter
{
    ...
    #[ORM\GeneratedValue]
    #[ORM\Column]
    #[Groups(['couplingFilter:read', "productInfo:read", 'productInfo:create'])]
    private ?int $id = null;

    #[ORM\Column(length: 50)]
    #[Groups(['couplingFilter:read', 'couplingFilter:create', 'couplingFilter:update', "productInfo:read", 'productInfo:create', 'enovaProduct:read'])]
