 ...
 */
final class Version20250303124815 extends AbstractMigration
{
...
//        $this->addSql('CREATE INDEX IDX_466113F63CF0C7D9 ON product_info (itypeid)');
        ...
        $this->addSql('ALTER TABLE user_enova DROP email');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_enova ADD email VARCHAR(180) NOT NULL');
