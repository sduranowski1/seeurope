 ...
 */
final class Version20250221114125 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category ADD description LONGTEXT DEFAULT NULL, ADD polish_description LONGTEXT DEFAULT NULL, ADD german_description LONGTEXT DEFAULT NULL');
...
//        $this->addSql('ALTER TABLE enova_contractor ADD PRIMARY KEY (id)');
        $this->addSql('ALTER TABLE item_type ADD description LONGTEXT DEFAULT NULL, ADD polish_description LONGTEXT DEFAULT NULL, ADD german_description LONGTEXT DEFAULT NULL');
...
//        $this->addSql('CREATE INDEX IDX_466113F63CF0C7D9 ON product_info (itypeid)');
        $this->addSql('ALTER TABLE subcategory ADD description LONGTEXT DEFAULT NULL, ADD polish_description LONGTEXT DEFAULT NULL, ADD german_description LONGTEXT DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE category DROP description, DROP polish_description, DROP german_description');
        ...
        $this->addSql('ALTER TABLE item_type DROP description, DROP polish_description, DROP german_description');
        ...
        $this->addSql('ALTER TABLE subcategory DROP description, DROP polish_description, DROP german_description');
    }
}
