 ...
 */
final class Version20250130140641 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE enova_person CHANGE tel_komórkowy tel_komorkowy VARCHAR(255) NOT NULL');
...
//        $this->addSql('CREATE INDEX IDX_466113F63CF0C7D9 ON product_info (itypeid)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE enova_person CHANGE tel_komorkowy tel_komórkowy VARCHAR(255) NOT NULL');
