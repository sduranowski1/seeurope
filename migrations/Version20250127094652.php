 ...
 */
final class Version20250127094652 extends AbstractMigration
{
...
//        $this->addSql('CREATE INDEX IDX_466113F63CF0C7D9 ON product_info (itypeid)');
        $this->addSql('ALTER TABLE variant ADD polish_name VARCHAR(50) NOT NULL, ADD german_name VARCHAR(50) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE variant DROP polish_name, DROP german_name');
    }
}
