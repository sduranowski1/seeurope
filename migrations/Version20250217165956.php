 ...
 */
final class Version20250217165956 extends AbstractMigration
{
...
//        $this->addSql('ALTER TABLE enova_contractor ADD PRIMARY KEY (id)');
        $this->addSql('ALTER TABLE orders CHANGE address address JSON NOT NULL COMMENT \'(DC2Type:json)\'');
...
//        $this->addSql('CREATE INDEX IDX_466113F63CF0C7D9 ON product_info (itypeid)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE orders CHANGE address address VARCHAR(255) DEFAULT NULL');
