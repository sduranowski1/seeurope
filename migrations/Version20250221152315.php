 ...
 */
final class Version20250221152315 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE brand ADD description LONGTEXT DEFAULT NULL, ADD polish_description LONGTEXT DEFAULT NULL, ADD german_description LONGTEXT DEFAULT NULL');
...
//        $this->addSql('CREATE INDEX IDX_466113F63CF0C7D9 ON product_info (itypeid)');
        $this->addSql('ALTER TABLE variant ADD description LONGTEXT DEFAULT NULL, ADD polish_description LONGTEXT DEFAULT NULL, ADD german_description LONGTEXT DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE brand DROP description, DROP polish_description, DROP german_description');
        ...
        $this->addSql('ALTER TABLE variant DROP description, DROP polish_description, DROP german_description');
    }
}
