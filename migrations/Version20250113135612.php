 ...
 */
final class Version20250113135612 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE enova_location ADD adres_location_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_C9F392EF526363DC ON enova_location (adres_location_id)');
        $this->addSql('CREATE INDEX IDX_C9F392EFA2D7CD83 ON enova_location (id_enova)');
...
//        $this->addSql('CREATE INDEX IDX_466113F63CF0C7D9 ON product_info (itypeid)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_C9F392EF526363DC ON enova_location');
        $this->addSql('DROP INDEX IDX_C9F392EFA2D7CD83 ON enova_location');
        $this->addSql('ALTER TABLE enova_location DROP adres_location_id');
