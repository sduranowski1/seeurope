 ...
 */
final class Version20250225120721 extends AbstractMigration
{
...
//        $this->addSql('ALTER TABLE enova_contractor ADD PRIMARY KEY (id)');
        $this->addSql('ALTER TABLE features_list ADD variant_id INT DEFAULT NULL, ADD category_id INT DEFAULT NULL, ADD subcategory_id INT DEFAULT NULL, ADD item_type_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE features_list ADD CONSTRAINT FK_A0DD474744F5D008 FOREIGN KEY (brand_id) REFERENCES brand (id)');
...
//        $this->addSql('CREATE INDEX IDX_466113F63CF0C7D9 ON product_info (itypeid)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE features_list DROP FOREIGN KEY FK_A0DD474744F5D008');
        ...
        $this->addSql('ALTER TABLE features_list DROP variant_id, DROP category_id, DROP subcategory_id, DROP item_type_id');
