 ...
 */
final class Version20250224154345 extends AbstractMigration
{
...
//        $this->addSql('ALTER TABLE enova_contractor ADD PRIMARY KEY (id)');
        $this->addSql('ALTER TABLE orders ADD requested_order_date DATETIME NOT NULL, ADD contact_person VARCHAR(255) DEFAULT NULL, ADD order_number VARCHAR(50) DEFAULT NULL, ADD shipping_method VARCHAR(50) DEFAULT NULL, DROP tax');
...
//        $this->addSql('CREATE INDEX IDX_466113F63CF0C7D9 ON product_info (itypeid)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE orders ADD tax DOUBLE PRECISION NOT NULL, DROP requested_order_date, DROP contact_person, DROP order_number, DROP shipping_method');
