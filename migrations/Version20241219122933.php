 ...
 */
final class Version20241219122933 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE enova_product ADD code VARCHAR(255) DEFAULT NULL, DROP product_info_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE enova_product ADD product_info_id INT DEFAULT NULL, DROP code');
