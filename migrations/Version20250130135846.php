 ...
 */
final class Version20250130135846 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE enova_person ADD dostep_do_www TINYINT(1) NOT NULL, ADD prawo_do_zamowien TINYINT(1) NOT NULL');
...
//        $this->addSql('CREATE INDEX IDX_466113F63CF0C7D9 ON product_info (itypeid)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE enova_person DROP dostep_do_www, DROP prawo_do_zamowien');
