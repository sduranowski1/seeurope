 ...
 */
final class Version20250110152818 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_C9F392EFB0265DC7 ON enova_location');
        $this->addSql('ALTER TABLE enova_location DROP contractor_id');
...
//        $this->addSql('CREATE INDEX IDX_466113F63CF0C7D9 ON product_info (itypeid)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE enova_location ADD contractor_id INT NOT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_C9F392EFB0265DC7 ON enova_location (contractor_id)');
