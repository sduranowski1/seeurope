 ...
 */
final class Version20250326152324 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE test_enova_address (id VARCHAR(255) NOT NULL, wojewodztwo VARCHAR(255) DEFAULT NULL, gmina VARCHAR(255) DEFAULT NULL, nr_domu VARCHAR(50) DEFAULT NULL, nr_lokalu VARCHAR(50) DEFAULT NULL, poczta VARCHAR(255) DEFAULT NULL, powiat VARCHAR(255) DEFAULT NULL, ulica VARCHAR(255) DEFAULT NULL, miejscowosc VARCHAR(255) DEFAULT NULL, kod_pocztowy VARCHAR(20) DEFAULT NULL, kraj VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE test_enova_contact_person (id INT NOT NULL, contractor_id INT DEFAULT NULL, adres_id VARCHAR(255) DEFAULT NULL, uuid INT NOT NULL, imie VARCHAR(255) NOT NULL, nazwisko VARCHAR(255) NOT NULL, stanowisko VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, tel_komorkowy VARCHAR(50) DEFAULT NULL, dostep_do_www TINYINT(1) NOT NULL, prawo_do_zamowien TINYINT(1) NOT NULL, INDEX IDX_54E64645B0265DC7 (contractor_id), INDEX IDX_54E64645F128501D (adres_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE test_enova_contractor (id INT AUTO_INCREMENT NOT NULL, adres_id VARCHAR(255) DEFAULT NULL, adres_korespondencyjny_id VARCHAR(255) DEFAULT NULL, id_enova INT NOT NULL, kod VARCHAR(255) NOT NULL, nazwa VARCHAR(255) NOT NULL, nip VARCHAR(20) DEFAULT NULL, regon VARCHAR(20) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, telefon VARCHAR(50) DEFAULT NULL, cena_kontrahenta_nazwa VARCHAR(255) DEFAULT NULL, adres_ulica VARCHAR(255) DEFAULT NULL, adres_miejscowosc VARCHAR(255) DEFAULT NULL, adres_kod_pocztowy VARCHAR(20) DEFAULT NULL, INDEX IDX_3E3E16E7F128501D (adres_id), INDEX IDX_3E3E16E7BCF7D015 (adres_korespondencyjny_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE test_enova_location (id INT AUTO_INCREMENT NOT NULL, contractor_id INT DEFAULT NULL, adres_id VARCHAR(255) DEFAULT NULL, uuid INT NOT NULL, kod VARCHAR(255) NOT NULL, nazwa VARCHAR(255) NOT NULL, INDEX IDX_B6BF6AE2B0265DC7 (contractor_id), INDEX IDX_B6BF6AE2F128501D (adres_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
